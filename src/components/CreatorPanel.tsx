        ...
        <div className="border-t border-ink-600 p-4">
          ...
          >
            {resetting ? (
              ...
              "Удалим ВСЕ аккаунты — включая ваш. Точно?"
            ) : (
              "Ваш номер тоже исчезнет — жмите"
            )}
          </button>
          <p className="mt-2 text-center font-mono text-[10px] text-ink-400">
            сотрёт всю коллекцию users, в том числе креатора. После сброса вас разлогинит —
            зарегистрируйтесь снова и получите корону с админкой.
          </p>
        </div>
      </div>
    </div>
